...
<template>
  <NuxtLink :to="`/events/${event.slug}`" class="group bg-white rounded-xl flex">
    ...
    <div class="flex flex-col w-full justify-between gap-1 p-5">
      <h3 class="font-bold text-md leading-tighter text-balance underline decoration-primary/0 group-hover:decoration-primary/50 transition-colors duration-300">{{ event.title }}</h3>
